...
from api.views.components import (
    ChampionsDataAPI,
    ChampionsDataJsonAPI,
    ItemsDataAPI,
)

router = routers.DefaultRouter()
router.register(r'allchampionjson', ChampionsDataJsonAPI,'champsss')
router.register(r'allchampion', ChampionsDataAPI,'champsss')
router.register(r'allitems', ItemsDataAPI,'champsss')

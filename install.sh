...
sudo apt-get update >> /home/mob_app_usr/frontenddeploy.sh

#update ubuntu system
sudo apt-get upgrade >> /home/mob_app_usr/frontenddeploy.sh

#install nginx
sudo apt-get install nginx-y >> /home/mob_app_usr/frontenddeploy.sh
